...
export default class AutoRestParameterFlattening extends AzureServiceClient {
  /**
...
export { AutoRestParameterFlattening, models as AutoRestParameterFlatteningModels };
