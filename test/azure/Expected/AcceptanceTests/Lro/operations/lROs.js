 ...
 * @returns {function} callback(err, result, request, response)
 */
function _postDoubleHeadersFinalLocationGet(options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginPostDoubleHeadersFinalLocationGet(options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 * @returns {function} callback(err, result, request, response)
 */
function _postDoubleHeadersFinalAzureHeaderGet(options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginPostDoubleHeadersFinalAzureHeaderGet(options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
 ...
 * @returns {function} callback(err, result, request, response)
 */
function _postDoubleHeadersFinalAzureHeaderGetDefault(options, callback) {
   /* jshint validthis: true */
  let client = this.client;
  if(!callback && typeof options === 'function') {
    callback = options;
  ...
  // Send request
  this.beginPostDoubleHeadersFinalAzureHeaderGetDefault(options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
...
function _beginPostDoubleHeadersFinalLocationGet(options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'lro/LROPostDoubleHeadersFinalLocationGet';
  let queryParameters = [];
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
  }
...
function _beginPostDoubleHeadersFinalAzureHeaderGet(options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'lro/LROPostDoubleHeadersFinalAzureHeaderGet';
  let queryParameters = [];
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
  }
...
function _beginPostDoubleHeadersFinalAzureHeaderGetDefault(options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'lro/LROPostDoubleHeadersFinalAzureHeaderGetDefault';
  let queryParameters = [];
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
  }
...
class LROs {
  ...
  constructor(client) {
    ...
    this._postDoubleHeadersFinalLocationGet = _postDoubleHeadersFinalLocationGet;
    this._postDoubleHeadersFinalAzureHeaderGet = _postDoubleHeadersFinalAzureHeaderGet;
    this._postDoubleHeadersFinalAzureHeaderGetDefault = _postDoubleHeadersFinalAzureHeaderGetDefault;
    ...
    this._beginPostDoubleHeadersFinalLocationGet = _beginPostDoubleHeadersFinalLocationGet;
    this._beginPostDoubleHeadersFinalAzureHeaderGet = _beginPostDoubleHeadersFinalAzureHeaderGet;
    this._beginPostDoubleHeadersFinalAzureHeaderGetDefault = _beginPostDoubleHeadersFinalAzureHeaderGetDefault;
   ...
   * @returns {Promise} A promise is returned.
   */
  postDoubleHeadersFinalLocationGetWithHttpOperationResponse(options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._postDoubleHeadersFinalLocationGet(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   * callback. Otherwise it returns a Promise.
   */
  postDoubleHeadersFinalLocationGet(options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._postDoubleHeadersFinalLocationGet(options, optionalCallback);
    }
  }
   ...
   * @returns {Promise} A promise is returned.
   */
  postDoubleHeadersFinalAzureHeaderGetWithHttpOperationResponse(options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._postDoubleHeadersFinalAzureHeaderGet(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   * callback. Otherwise it returns a Promise.
   */
  postDoubleHeadersFinalAzureHeaderGet(options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._postDoubleHeadersFinalAzureHeaderGet(options, optionalCallback);
    }
  }
   ...
   * @returns {Promise} A promise is returned.
   */
  postDoubleHeadersFinalAzureHeaderGetDefaultWithHttpOperationResponse(options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._postDoubleHeadersFinalAzureHeaderGetDefault(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   * callback. Otherwise it returns a Promise.
   */
  postDoubleHeadersFinalAzureHeaderGetDefault(options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._postDoubleHeadersFinalAzureHeaderGetDefault(options, optionalCallback);
    }
  }
   ...
   * @returns {Promise} A promise is returned.
   */
  beginPostDoubleHeadersFinalLocationGetWithHttpOperationResponse(options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginPostDoubleHeadersFinalLocationGet(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   * callback. Otherwise it returns a Promise.
   */
  beginPostDoubleHeadersFinalLocationGet(options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginPostDoubleHeadersFinalLocationGet(options, optionalCallback);
    }
  }
   ...
   * @returns {Promise} A promise is returned.
   */
  beginPostDoubleHeadersFinalAzureHeaderGetWithHttpOperationResponse(options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginPostDoubleHeadersFinalAzureHeaderGet(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   * callback. Otherwise it returns a Promise.
   */
  beginPostDoubleHeadersFinalAzureHeaderGet(options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginPostDoubleHeadersFinalAzureHeaderGet(options, optionalCallback);
    }
  }
   ...
   * @returns {Promise} A promise is returned.
   */
  beginPostDoubleHeadersFinalAzureHeaderGetDefaultWithHttpOperationResponse(options) {
    let client = this.client;
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginPostDoubleHeadersFinalAzureHeaderGetDefault(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
   ...
   * callback. Otherwise it returns a Promise.
   */
  beginPostDoubleHeadersFinalAzureHeaderGetDefault(options, optionalCallback) {
    let client = this.client;
    let self = this;
    if (!optionalCallback && typeof options === 'function') {
      optionalCallback = options;
    ...
    if (!optionalCallback) {
      ...
      return self._beginPostDoubleHeadersFinalAzureHeaderGetDefault(options, optionalCallback);
    }
  }
