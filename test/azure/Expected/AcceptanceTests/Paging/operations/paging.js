...
function _getMultiplePagesLRO(options, callback) {
  ...
  // Send request
  this.beginGetMultiplePagesLRO(options, (err, parsedResult, httpRequest, response) => {
...
function _beginGetMultiplePagesLRO(options, callback) {
  ...
  // Construct URL
  let baseUrl = this.client.baseUri;
  let requestUrl = baseUrl + (baseUrl.endsWith('/') ? '' : '/') + 'paging/multiple/lro';
  let queryParameters = [];
  if (queryParameters.length > 0) {
    requestUrl += '?' + queryParameters.join('&');
  }
...
function _getMultiplePagesLRONext(nextPageLink, options, callback) {
  ...
  // Send request
  this.beginGetMultiplePagesLRONext(nextPageLink, options, (err, parsedResult, httpRequest, response) => {
    if (err) return callback(err);
...
class Paging {
  ...
  constructor(client) {
    ...
    this._getMultiplePagesLRO = _getMultiplePagesLRO;
    this._nextFragment = _nextFragment;
    this._nextFragmentWithGrouping = _nextFragmentWithGrouping;
    this._beginGetMultiplePagesLRO = _beginGetMultiplePagesLRO;
    ...
    this._getMultiplePagesLRONext = _getMultiplePagesLRONext;
    this._beginGetMultiplePagesLRONext = _beginGetMultiplePagesLRONext;
  }
  ...
  getMultiplePagesLROWithHttpOperationResponse(options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._getMultiplePagesLRO(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  getMultiplePagesLRO(options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._getMultiplePagesLRO(options, optionalCallback);
    }
  }
  ...
  beginGetMultiplePagesLROWithHttpOperationResponse(options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginGetMultiplePagesLRO(options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  beginGetMultiplePagesLRO(options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._beginGetMultiplePagesLRO(options, optionalCallback);
    }
  }
  ...
  getMultiplePagesLRONextWithHttpOperationResponse(nextPageLink, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._getMultiplePagesLRONext(nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  getMultiplePagesLRONext(nextPageLink, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._getMultiplePagesLRONext(nextPageLink, options, optionalCallback);
    }
  }
  ...
  beginGetMultiplePagesLRONextWithHttpOperationResponse(nextPageLink, options) {
    ...
    let self = this;
    return new Promise((resolve, reject) => {
      self._beginGetMultiplePagesLRONext(nextPageLink, options, (err, result, request, response) => {
        let httpOperationResponse = new msRest.HttpOperationResponse(request, response);
        httpOperationResponse.body = result;
        if (err) { reject(err); }
        else { resolve(httpOperationResponse); }
  ...
  beginGetMultiplePagesLRONext(nextPageLink, options, optionalCallback) {
    ...
    if (!optionalCallback) {
      ...
      return self._beginGetMultiplePagesLRONext(nextPageLink, options, optionalCallback);
    }
  }
