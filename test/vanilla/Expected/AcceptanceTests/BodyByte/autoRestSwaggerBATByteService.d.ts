...
export default class AutoRestSwaggerBATByteService extends ServiceClient {
  /**
   * @class
...
export { AutoRestSwaggerBATByteService, models as AutoRestSwaggerBATByteServiceModels };
