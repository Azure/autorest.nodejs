...
/**
 * Class representing a PetAPInPropertiesWithAPString.
 */
class PetAPInPropertiesWithAPString {
  ...
  /**
   * Defines the metadata of PetAPInPropertiesWithAPString
   *
   * @returns {object} metadata of PetAPInPropertiesWithAPString
   *
   */
  mapper() {
    return {
...
module.exports = PetAPInPropertiesWithAPString;
