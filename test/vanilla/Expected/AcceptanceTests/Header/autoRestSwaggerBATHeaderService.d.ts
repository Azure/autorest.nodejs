...
export default class AutoRestSwaggerBATHeaderService extends ServiceClient {
  /**
   * @class
...
export { AutoRestSwaggerBATHeaderService, models as AutoRestSwaggerBATHeaderServiceModels };
