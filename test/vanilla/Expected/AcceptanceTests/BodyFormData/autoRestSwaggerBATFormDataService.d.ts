...
export default class AutoRestSwaggerBATFormDataService extends ServiceClient {
  /**
   * @class
...
export { AutoRestSwaggerBATFormDataService, models as AutoRestSwaggerBATFormDataServiceModels };
