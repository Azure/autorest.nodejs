...
namespace AutoRest.NodeJS.DSL
{
    ...
    {
        private List<JSPosition> argumentPositions;
        ...
        public JSArgumentList(JSBuilder builder)
            : base(builder)
        {
            argumentPositions = new List<JSPosition>();
        }
        ...
        public void Dispose()
        {
            if (argumentPositions.Count >= 2)
            {
                ...
                {
                    foreach (JSPosition argumentPosition in argumentPositions)
                    {
                ...
                {
                    foreach (JSPosition argumentPosition in argumentPositions.Skip(1))
                    {
